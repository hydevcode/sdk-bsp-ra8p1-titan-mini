...
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 1.6e-7 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x28, .duty_cycle_counts = 0x14, .source_div = (timer_source_div_t)0,
    .channel             = 2,
    .p_callback          = NULL,
