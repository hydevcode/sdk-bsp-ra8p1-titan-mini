...
#define ARDUINO_A3_MIKROBUS_AN (BSP_IO_PORT_00_PIN_04)
...
#define CAM_INT (BSP_IO_PORT_00_PIN_10)
#define ARDUINO_D2 (BSP_IO_PORT_00_PIN_11)
#define PMOD2_7_IRQ15 (BSP_IO_PORT_00_PIN_12)
#define I2C_SCL0_PULLUP (BSP_IO_PORT_00_PIN_13)
#define ARDUINO_A4 (BSP_IO_PORT_00_PIN_14)
#define ARDUINO_A5 (BSP_IO_PORT_00_PIN_15)
#define OSPI_DQ0_ARDUINO_D12_MISOB_MIKROBUS_MISOB (BSP_IO_PORT_01_PIN_00)
#define OSPI_DQ3_ARDUINO_D11_MOSIB_MIKROBUS_MOSIB (BSP_IO_PORT_01_PIN_01)
#define OSPI_DQ4_ARDUINO_D13_RSPCKB_MIKROBUS_RSPCKB (BSP_IO_PORT_01_PIN_02)
#define OSPI_DQ2_ARDUINO_D10_SSLB_MIKROBUS_SSLB (BSP_IO_PORT_01_PIN_03)
#define OSPI_CS_ARDUINO_D5 (BSP_IO_PORT_01_PIN_04)
#define OSPI_INT_ARDUINO_D6 (BSP_IO_PORT_01_PIN_05)
#define OSPI_RES (BSP_IO_PORT_01_PIN_06)
#define ETH_MDINT (BSP_IO_PORT_01_PIN_07)
#define I2C_SDA0_PULLUP (BSP_IO_PORT_01_PIN_09)
#define ARDUINO_D9 (BSP_IO_PORT_01_PIN_10)
#define LCD_INT_MIPI_IRQ19 (BSP_IO_PORT_01_PIN_11)
...
#define MD_MIKROBUS_RES (BSP_IO_PORT_02_PIN_01)
#define ENET_RX_CTL (BSP_IO_PORT_02_PIN_06)
...
#define ETH_TXD3_TRACE_TDATA3 (BSP_IO_PORT_03_PIN_04)
#define ETH_TXD2_TRACE_TDATA2 (BSP_IO_PORT_03_PIN_05)
#define ETH_TXD1_TRACE_TDATA1 (BSP_IO_PORT_03_PIN_06)
#define ETH_TXD0_TRACE_TDATA0 (BSP_IO_PORT_03_PIN_07)
#define TRACE_TCLK (BSP_IO_PORT_03_PIN_08)
#define ETH_TX_CLK (BSP_IO_PORT_03_PIN_09)
#define ETH_TX_CTL (BSP_IO_PORT_03_PIN_10)
...
#define CAM_XCLK (BSP_IO_PORT_05_PIN_01)
...
#define LCD_CLK (BSP_IO_PORT_05_PIN_15)
#define USER_LED1_BLUE (BSP_IO_PORT_06_PIN_00)
#define PMOD2_4_RSPCKB (BSP_IO_PORT_06_PIN_01)
#define PMOD2_3_MISOB_RXD0 (BSP_IO_PORT_06_PIN_02)
#define PMOD2_2_MOSIB_TXD0 (BSP_IO_PORT_06_PIN_03)
#define PMOD2_1_SSLB0_CTS_RTS0 (BSP_IO_PORT_06_PIN_04)
#define PMOD2_1_CTS0 (BSP_IO_PORT_06_PIN_05)
...
#define OSPI_DQ5_PMOD1_1_CTS2 (BSP_IO_PORT_08_PIN_00)
...
#define LCD_HSYNC_TCON1 (BSP_IO_PORT_08_PIN_05)
#define LCD_VSYNC_TCON0 (BSP_IO_PORT_08_PIN_06)
#define LCD_DE_TCON2 (BSP_IO_PORT_08_PIN_07)
#define OSPI_SCLK_ARDUINO_D0_RXD_MIKROBUS_RXD (BSP_IO_PORT_08_PIN_08)
#define ARDUINO_D1_TXD_MIKROBUS_TXD (BSP_IO_PORT_08_PIN_09)
#define ARDUINO_D4_MIKROBUS_1_PWM (BSP_IO_PORT_08_PIN_10)
#define ARDUINO_D3 (BSP_IO_PORT_08_PIN_11)
...
#define CAM_D1_LCD_D3 (BSP_IO_PORT_09_PIN_02)
#define LCD_D2 (BSP_IO_PORT_09_PIN_03)
#define LCD_D8 (BSP_IO_PORT_09_PIN_04)
#define ETH_RX_CLK (BSP_IO_PORT_09_PIN_05)
#define ETH_RXD0 (BSP_IO_PORT_09_PIN_06)
#define ETH_RXD1 (BSP_IO_PORT_09_PIN_07)
#define ETH_RXD2 (BSP_IO_PORT_09_PIN_08)
#define ETH_RXD3 (BSP_IO_PORT_09_PIN_09)
#define LCD_D4 (BSP_IO_PORT_09_PIN_10)
#define LCD_D5 (BSP_IO_PORT_09_PIN_11)
#define LCD_D6 (BSP_IO_PORT_09_PIN_12)
#define LCD_D7 (BSP_IO_PORT_09_PIN_13)
#define LCD_D0 (BSP_IO_PORT_09_PIN_14)
#define LCD_D1 (BSP_IO_PORT_09_PIN_15)
...
#define CAM_VSYNC_LCD_D16 (BSP_IO_PORT_11_PIN_02)
#define CAM_HSYNC_LCD_D15 (BSP_IO_PORT_11_PIN_03)
#define CAM_PCLK_LCD_D14 (BSP_IO_PORT_11_PIN_04)
...
#define ARDUINO_D8_MIKROBUS_INT (BSP_IO_PORT_13_PIN_01)
#define JLINK_VCOM_TX (BSP_IO_PORT_13_PIN_02)
#define JLINK_VCOM_RXD (BSP_IO_PORT_13_PIN_03)
#define JLINK_VCOM_CTS_RTS (BSP_IO_PORT_13_PIN_04)
#define JLINK_VCOM_CTS (BSP_IO_PORT_13_PIN_05)
#define AUDIO_MCLK (BSP_IO_PORT_13_PIN_06)
