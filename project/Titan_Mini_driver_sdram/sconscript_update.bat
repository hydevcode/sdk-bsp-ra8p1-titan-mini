@echo off
call C:/Softwares/RT-ThreadStudio/platform/env_released/env-new/.venv/Scripts/activate.bat
cd /d C:\Softwares\RT-ThreadStudio\workspace\RA8P1-MINI\Titan_Mini_sdram_6.3.0
set RTT_ROOT=
set ENV_ROOT=C:/Softwares/RT-ThreadStudio/platform/env_released/env-new
set RTT_EXEC_PATH=C:/Softwares/RT-ThreadStudio/repo/Extract/ToolChain_Support_Packages/ARM/GNU_Tools_for_ARM_Embedded_Processors/13.3/bin
