 ...
 * 2025-06-23     Rbb666       Added support for independent SDIO bus width Kconfig
 */
...
static rt_int32_t ra_sdhi_get_card_status(struct rt_mmcsd_host *host)
{
...
static void ra_sdhi_enable_sdio_irq(struct rt_mmcsd_host *host, rt_int32_t en)
{
    struct rthw_sdio *sdio = host->private_data;
...
int rt_hw_sdhi_init(void)
{
    ...
    sdhi0.bus_width = BSP_SDHI0_BUS_WIDTH; /* Set bus width from Kconfig */
    ...
    sdhi1.bus_width = BSP_SDHI1_BUS_WIDTH; /* Set bus width from Kconfig */
